select
	/* 
        query for treat_X_X_condition3.csv
            : extract the number of surviving & deleted question
            : To account for online exposure, we only consider questions as deleted when they were erased within one year of posting 
    */
	x.cdate ,
	x.del_yn, 
